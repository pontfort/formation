...
@NamedEntityGraphs({ @NamedEntityGraph(name = "brancheMere", attributeNodes = { @NamedAttributeNode(value = "mere") }),
		@NamedEntityGraph(name = "brancheChildren", attributeNodes = {
				@NamedAttributeNode(value = "enfants", subgraph = "sousGrapheFeuilleSortie") }, subgraphs = {
						@NamedSubgraph(name = "sousGrapheFeuilleSortie", attributeNodes = {
...
public class Personne implements Serializable {
	...
	// (Cas 2) -> La reference est porté par une table personne_feuillesortie
	// qui contient les primary keys de Personne et FeuilleSortie
